...
var NodePackageManager = (function () {
    ...
    NodePackageManager.prototype.load = function (config) {
        if (npm.config.loaded) {
            var data_1 = npm.config.sources.cli.data;
            Object.keys(data_1).forEach(function (k) { return delete data_1[k]; });
            if (config) {
                _.assign(data_1, config);
            }
    ...
    NodePackageManager.prototype.search = function (filter, silent) {
        var args = ([filter] || []).concat(silent);
