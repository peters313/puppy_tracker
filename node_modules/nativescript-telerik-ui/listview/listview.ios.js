...
var TKListViewDataSourceImpl = (function (_super) {
    ...
    TKListViewDataSourceImpl.prototype.listViewCellForItemAtIndexPath = function (listView, indexPath) {
        ...
        this._owner.layoutCell(cell, indexPath);
        return cell;
    };
        ...
        if (touchEvent.tapCount === 1) {
            if (this.owner.hasListeners(commonModule.RadListView.itemTapEvent)) {
                var args = {
                    ...
                    groupIndex: this.currentIndexPath.section
                };
...
var RadListView = (function (_super) {
    ...
    RadListView.prototype.getHeightForCell = function (index) {
    ...
    RadListView.prototype.onSourceCollectionChanged = function (data) {
        if (!this.listViewLayout.itemInsertAnimation && !this.listViewLayout.itemDeleteAnimation
            || data.action === observableArray.ChangeType.Update) {
    ...
    RadListView.prototype.layoutCell = function (cell, indexPath) {
        ...
        var dimensions = this.prepareCell(cell, indexPath);
        var cellView = cell.view.itemView;
        if (cellView) {
            viewModule.View.layoutChild(this, cellView, 0, 0, dimensions.regularViewMeasuredSize.measuredWidth, dimensions.regularViewMeasuredSize.measuredHeight);
        }
        var backgroundView = cell.view.itemSwipeView;
        if (backgroundView) {
            viewModule.View.layoutChild(this, backgroundView, 0, 0, dimensions.swipeViewMeasuredSize.measuredWidth, dimensions.swipeViewMeasuredSize.measuredHeight);
        }
    };
    RadListView.prototype.measureCell = function (cellView, indexPath, sizeRestriction) {
        if (cellView) {
    ...
    RadListView.prototype.prepareCell = function (tableCell, indexPath) {
        ...
        var regularViewDesiredSize = this.measureCell(cell.view.itemView, indexPath);
        ...
        var swipeViewDesiredSize = this.measureCell(cell.view.itemSwipeView, indexPath, { width: regularViewDesiredSize.measuredWidth, height: regularViewDesiredSize.measuredHeight });
        return {
