...
var IOSApplicationManager = (function (_super) {
    ...
    IOSApplicationManager.prototype.getApplicationsLiveSyncSupportedStatus = function () {
        ...
        return (function () {
            ...
            try {
                ...
                _this.applicationsLiveSyncStatus = [];
                _.each(result, function (singleResult) {
                    var currentList = _.map(singleResult.CurrentList, function (app) { return ({ applicationIdentifier: app.CFBundleIdentifier, isLiveSyncSupported: app.IceniumLiveSyncEnabled }); });
                    _this.applicationsLiveSyncStatus = _this.applicationsLiveSyncStatus.concat(currentList);
                });
                return _this.applicationsLiveSyncStatus;
            }
            finally {
                installationProxy.closeSocket();
            }
    ...
    IOSApplicationManager.prototype.isLiveSyncSupported = function (appIdentifier) {
        var _this = this;
        return (function () {
            var selectedApplication = _.find(_this.applicationsLiveSyncStatus, function (app) { return app.applicationIdentifier === appIdentifier; });
